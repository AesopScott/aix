...
Registration records include name, company, title, industry, company email, phone, role selections, phone verification status, and separate publication-use opt-ins for name and company.
