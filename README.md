...
The partner pricing structure page lives at `/partner-pricing/` and presents the partner-facing Executive slot subscription model as a static HTML reference. It covers Candidate pricing, clarifies that Partner Candidates are not approved Partners and do not receive Partner discounts, the Have a Taste first-quarter introductory program for brand-new Partner Candidates, Tier 1 Research Partner at $1,000 per quarter, Tier 2 Summit Partner at $5,000 per quarter total, Tier 3 Strategic Partner at $10,000 per quarter total under an annual subscription, annual payment and Executive slot discounts, SMB pricing, and agreement details. The private partner profile page links to this route from its header navigation.
